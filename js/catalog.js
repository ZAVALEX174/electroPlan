...
/* Товары, подходящие помещению по его ОТДЕЛКЕ. criteria — объект-критерий; сегодня единственный
   ...
   (тот же источник, что и series товара) → регистр заведомо совпадает. Если же в room.collection
   попал мусор иного регистра (старый/правленый проект), пустой результат — штатная деградация
   «битой» коллекции в весь каталог (collectionFramePool), а не тихая подмена состава. */
