...
function makeCtx(state, dom) {
  ...
  const ctx = {
    ...
    renderBuilder: () => {},
    builderCtx: {},
    collectionFramePool: frames => frames, frameFacingHintText: () => "", EPCatalog, builderInnardsFilter: () => ({}), builderFilterRoom: () => null, frameFacingList: () => [], EPRoom: { roomFrameFacing: () => null },
