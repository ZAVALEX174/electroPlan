...
const FILTER_CUT = ["frameCollectionList", "frameFacingList", "builderRoomFilter"];
...
const POOL_CUT = ["frameCollectionList", "frameFacingList", "builderRoomFilter", "collectionFramePool"];
