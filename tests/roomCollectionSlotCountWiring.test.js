...
const SLOT_CUT = ["frameCollectionList", "frameFacingList", "builderFilterRoom", "builderRoomFilter", "builderInnardsFilter", "collectionFramePool", "renderPostSlotCountSelect"];
...
const BUILDER_CUT = ["frameCollectionList", "frameFacingList", "builderFilterRoom", "builderRoomFilter", "builderInnardsFilter", "collectionFramePool", "frameFacingLabels", "frameFacingHintText", "frameOptions", "builderCapacity", "renderBuilder"];
